      ...
      <main>
        ...
        <Section tall={false}>
          ...
          <P1 centered className="mt-2 text-lg">
            ...
            plans. By combining cutting edge AI with clean UX, BenAI helps
            members maximize their benefits, reduces administrative load, and
            enhances support quality for healthcare administrators.
          </P1>
        ...
        <Section tall={false}>
          ...
          <div className="text-grey-800 text-center">
            ...
            <p className="mx-auto max-w-3xl text-base">
              We created a modular agent framework for BenAI to enable
              intelligent data retrieval and workflow execution. A central
              Routing Agent dynamically selects specialized sub-agents—such as
              Plan Context, Claim Status, and Doctor Network Agents—based on the
              user's question. These agents fetch information from relevant data
              sources (e.g. Group Data, Claims API, Doctor Network) and return
              structured context to a Summarizer, which formulates a precise,
              user-facing response. The system is designed for scalability,
              supporting easy integration of future agents and APIs.
            </p>
          </div>
        </Section>
          ...
          <Section tall={false}>
            <div className="text-center">
              ...
              <P1 centered className="mx-auto mt-2 max-w-2xl text-white">
                BenAI is just one example of how our team helps clients harness
                AI to solve real business problems. Whether you're streamlining
